...
def phonebook_processing():
    ...
    pattern = re.compile(r'\+?[78]\s?\(?(\d{3})\)?[\s|-]?(\d{3})-?'
    ...
    return f'Модифицированная телефонная книга записана в файл {os.path.join(module_dir, "phonebook.csv")}'


if __name__ == '__main__':
    print(phonebook_processing())